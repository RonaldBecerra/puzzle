// The texts that appear in the game
const game_texts = {
	spanish: [
		{identifier:"movements-title", content:"Movidas"}, // 0
		{identifier:"lblTitleConfirmAcceptCancel", content: "Confirmación"}, // 1
		{identifier:"lblMsgConfirmAcceptCancel", content: "¿Seguro de que desea reiniciar la partida?<br>Se perderá su progreso."}, // 2
		{identifier:"btnAcceptConfirm", content: "Aceptar"}, // 3
	...
	english: [
		...
		{identifier:"lblTitleConfirmAcceptCancel", content: "Confirmation"}, // 1
		{identifier:"lblMsgConfirmAcceptCancel", content: "Are you sure you want to restart the game?<br>Your progress will be lost."}, // 2
		{identifier:"btnAcceptConfirm", content: "Accept"}, // 3

...
function createManifestationsFigures(){
	...
	for (i=0; i < texts.length; i++){
		let elem = texts[i].toLowerCase().replaceAll(' ','_');
		elem = prefix + elem + "/";
...
const manifestations_texts = {
	spanish: [
		{ // 0
			label: `<span style="color:var(--red-manifestation)">Petroglifo</span><br>Rancho 505<br>Estado Zulia<br>Venezuela`,
		...
		{ // 1
			label: `<span style="color:var(--purple-manifestation)">Pintura Rupestre</span><br>Cueva del Carmen<br>Estado Bolívar<br>Venezuela`,
		...
		{ // 2
			label: `<span style="color:var(--green-manifestation)">Dolmen</span><br>Pintao<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 3
			label: `<span style="color:var(--green-manifestation)">Menhires</span><br>Vigirima<br>Estado Carabobo<br>Venezuela`,
		...
		{ // 4
			label: `<span style="color:var(--green-manifestation)">Monolitos</span><br>Río Vigirima<br>Estado Carabobo<br>Venezuela`,
		...
		{ // 5
			label: `<span style="color:var(--gray-manifestation)">Amoladores</span><br>Salto Parú<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 6
			label: `<span style="color:var(--gray-manifestation)">Cúpulas</span><br>Mariara<br>Estado Carabobo<br>Venezuela`,
		...
		{ // 7
			label: `<span style="color:var(--gray-manifestation)">Batea</span><br>Laja de Tigre, Río Ocamo<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 8
			label: `<span style="color:var(--gray-manifestation)">Puntos Acoplados</span><br>Átures<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 9
			label: `<span style="color:var(--blue-manifestation)">Piedras Míticas Naturales</span><br>Olla de Napiruli<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 10
			label: `<span style="color:var(--blue-manifestation)">Cerro Mítico Natural</span><br>Cerro Autana<br>Estado Amazonas<br>Venezuela`,
		...
		{ // 11
			label: `<span style="color:var(--burgundy-manifestation)">Esferas Líticas</span><br>Onoto<br>Estado Anzoátegui<br>Venezuela`,
		...
		{ // 12
			label: `<span style="color:var(--orange-manifestation)">Geoglifo</span><br>Rueda del Indio<br>Chirgua<br>Estado Carabobo<br>Venezuela`,
		...
		{ // 13
			label: `<span style="color:var(--ocher-manifestation)">Micropetroglifos</span><br>San Pablo<br>Estado Carabobo<br>Venezuela`,
	...
	english: [
		{ // 0
			label: `<span style="color:var(--red-manifestation)">Petroglyph</span><br>505 Ranch<br>Zulia state<br>Venezuela`,
		...
		{ // 1
			label: `<span style="color:var(--purple-manifestation)">Rock Painting</span><br>Cueva del Carmen<br>Bolívar state<br>Venezuela`,
		...
		{ // 2
			label: `<span style="color:var(--green-manifestation)">Dolmen</span><br>Pintao<br>Amazonas state<br>Venezuela`,
		...
		{ // 3
			label: `<span style="color:var(--green-manifestation)">Menhirs</span><br>Vigirima<br>Carabobo state<br>Venezuela`,
		...
		{ // 4
			label: `<span style="color:var(--green-manifestation)">Monoliths</span><br>Vigirima River<br>Carabobo state<br>Venezuela`,
		...
		{ // 5
			label: `<span style="color:var(--gray-manifestation)">Whetstones</span><br>Parú Falls<br>Amazonas state<br>Venezuela`,
		...
		{ // 6
			label: `<span style="color:var(--gray-manifestation)">Domes</span><br>Mariara<br>Carabobo state<br>Venezuela`,
		...
		{ // 7
			label: `<span style="color:var(--gray-manifestation)">Trough</span><br>Laja de Tigre, Ocamo River<br>Amazonas state<br>Venezuela`,
		...
		{ // 8
			label: `<span style="color:var(--gray-manifestation)">Coupled points</span><br>Átures<br>Amazonas state<br>Venezuela`,
		...
		{ // 9
			label: `<span style="color:var(--blue-manifestation)">Natural Mythical Stones</span><br>Olla de Napiruli<br>Amazonas state<br>Venezuela`,
		...
		{ // 10
			label: `<span style="color:var(--blue-manifestation)">Natural Mythical Hills</span><br>Autana Hill<br>Amazonas state<br>Venezuela`,
		...
		{ // 11
			label: `<span style="color:var(--burgundy-manifestation)">Stones Spheres</span><br>Onoto<br>Anzoátegui state<br>Venezuela`,
		...
		{ // 12
			label: `<span style="color:var(--orange-manifestation)">Geoglyph</span><br>Rueda del Indio<br>Chirgua<br>Carabobo state<br>Venezuela`,
		...
		{ // 13
			label: `<span style="color:var(--ocher-manifestation)">Micropetroglyphs</span><br>San Pablo<br>Carabobo state<br>Venezuela`,
